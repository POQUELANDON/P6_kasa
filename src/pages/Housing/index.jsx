...
const Housing = () => {
  ...
  // Si aucun ID n'est fourni dans l'URL, essayez de le récupérer à partir du stockage local
  if (!id) {
    id = localStorage.getItem('logementId');
  } else {
    // Si un ID est fourni, mettez à jour le stockage local
    localStorage.setItem('logementId', id);
  }
